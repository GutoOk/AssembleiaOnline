    ...
    <Sheet open={isAttendeesSheetOpen} onOpenChange={setIsAttendeesSheetOpen}>
        <SheetContent className="w-full sm:max-w-md p-0 flex flex-col">
            ...
            <p className="text-foreground">
                Visualizando agora: <b>{attendees.length} membros</b> acompanham esta assembleia.
            </p>
            <div className="flex items-start gap-2.5 text-sm text-amber-900 dark:text-amber-100 bg-amber-50 dark:bg-amber-900/20 p-3 rounded-lg border border-amber-200 dark:border-amber-500/30">
